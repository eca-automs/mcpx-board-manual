...
#### Descrizione
Alla fermata (induttori IS e ID chiusi) viene avviato un timer dalla durata fissa di 4 secondi.
...
#### Descrizione
Ad impianto fermo (induttori IS e ID chiusi), scaduto il timer di 4 secondi di controllo
